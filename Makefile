...
validate-draft:
	...
	$(PYTHON) scripts/40_validate_draft_claim_compliance.py

paper-draft-export: paper-figures paper-tables export-submission validate-draft
